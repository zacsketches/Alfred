...
namespace Control {
    ...
    const Cmd_velocity_msg backtwist_CW  ("b__cw", Direction::bck,  10, Direction::bck,  90);
    const Cmd_velocity_msg backtwist_CCW ("b_ccw", Direction::bck, 115, Direction::bck,  10);
